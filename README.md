...
| 3a | [Understanding Rule Expressions](./docs/03a-rule-expressions.md) | 15 min |
...
- ✅ Deploy a website with automatic HTTPS and global CDN
...
4. Learn [Module 3a: Understanding Rule Expressions](./docs/03a-rule-expressions.md)
5. Finish with [Module 4: Zero Trust Network Access](./docs/04-ztna.md)
6. Test DNS blocking and secure application access
7. Review logs to see blocked queries and access events
